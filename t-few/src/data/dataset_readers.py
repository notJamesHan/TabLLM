...
DATASETS_OFFLINE = "/home/james/Documents/github/TabLLM/datasets_serialized"
...
class CustomCategoricalReader(BaseDatasetReader):
    ...
    def get_template(self, template_idx):
        ...
        yaml_dict = yaml.load(open('/home/james/Documents/github/TabLLM/templates/templates_' + task + '.yaml', "r"),
